...
/*******************************/
/*Audio encode type  Add by Sue 20130416*/
typedef enum
{
    VSYS_AUD_CODEC_G729,
    VSYS_AUD_CODEC_G726,
...
static UInt32 Vsys_getResSize(UInt32 res, UInt32 *width, UInt32 *height)
{
    switch (res)
    {
        case VSYS_STD_MAX:
...
static UInt32 Vsys_getResRate(UInt32 res, UInt32 *frameRate)
{
    switch (res)
    {
        case VSYS_STD_MAX:
...
static UInt32 Vsys_isResInterlaced(UInt32 res)
{
