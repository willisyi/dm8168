...
/**
 * \file vpshalVpdmaDefaultsTI813x.h
 *
...
#ifndef _VPSSHALVPDMADEFAULTS_TI813X_H
#define _VPSSHALVPDMADEFAULTS_TI813X_H
...
#define VPSHAL_VPDMA_DEFAULT_CHANNEL_INFO                                      \
    ...
    {VPSHAL_VPDMA_CHANNEL_PRI_FLD2_CHROMA,                                     \
        ...
        VPSHAL_VPDMA_MT_NONTILEDMEM, 0},                                       \
    {VPSHAL_VPDMA_CHANNEL_INVALID, (Int)NULL, VPSHAL_VPDMA_MT_NONTILEDMEM, 0},      \
    {VPSHAL_VPDMA_CHANNEL_INVALID, (Int)NULL, VPSHAL_VPDMA_MT_NONTILEDMEM, 0},      \
    {VPSHAL_VPDMA_CHANNEL_INVALID, (Int)NULL, VPSHAL_VPDMA_MT_NONTILEDMEM, 0},      \
    {VPSHAL_VPDMA_CHANNEL_INVALID, (Int)NULL, VPSHAL_VPDMA_MT_NONTILEDMEM, 0},      \
    {VPSHAL_VPDMA_CHANNEL_INVALID, (Int)NULL, VPSHAL_VPDMA_MT_NONTILEDMEM, 0},      \
...
#endif /* #ifndef _VPSSHALVPDMADEFAULTS_TI813X_H */
