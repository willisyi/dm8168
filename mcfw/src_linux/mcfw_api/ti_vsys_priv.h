...
Int32 MultiCh_progressive8ChNrtVcapVencVdecVdisSetCapFrameRate(VCAP_CHN vcChnId, VCAP_STRM vStrmId, Int32 inputFrameRate, Int32 outputFrameRate);
Int32 MultiCh_progressive8ChNrtVcapVencVdecVdisEnableDisableCapChn(VCAP_CHN vcChnId, VCAP_STRM vStrmId, Bool enableChn);
Int32 MultiCh_progressive8ChNrtVcapVencVdecVdisSetOutRes(VCAP_CHN vcChnId, VCAP_CHN_DYNAMIC_PARAM_S *psCapChnDynaParam);
Int32 MultiCh_progressive8ChNrtVcapVencVdecVdisGetOutRes(VCAP_CHN vcChnId, VCAP_CHN_DYNAMIC_PARAM_S *psCapChnDynaParam);
